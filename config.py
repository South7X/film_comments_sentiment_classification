...
def config():
    ...
    parser.add_argument("--pretrained_path",default="./pretrained_bert/bert-chinese-base",type=str,required=False)
    ...
    parser.add_argument('--num_labels',default=2,type=int,required=False)
    parser.add_argument("--resume_model_path",default="bert_out/model",type=str,required=False)
    ...
    parser.add_argument("--train_name",default="train.csv",type=str,required=False)
    parser.add_argument("--dev_name",default="dev.csv",type=str,required=False)
    parser.add_argument("--test_name",default="test1_data.csv",type=str,required=False)
    ...
    parser.add_argument("--eval_steps",default=20,type=int,required=False)
    parser.add_argument("--out_dir",type=str,default="./bert_out")
...
if __name__=="__main__":
    print(os.path.isdir("./bert_chinese_base"))